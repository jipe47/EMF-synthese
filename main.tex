...
\begin{document}	
	...
	\input{0-intro}
	\input{1-monnaie}
	\input{2-demande-monnaie}
	\input{3-crise-financiere}
	\input{4-banque-gestion-institution-financiere}
	\input{5-basel}
	\input{6-offre-monnaie}
	\input{7-politique-monetaire}
	\input{8-produits-derives}
\end{document}	